...
render() {
    return (
      <div>
        <input type="number" className="setSum" ref={(input1) => this.textInput1 = input1} onKeyDown={this.handleKeyDown1} />
        <input type="number" className="setSum" ref={(input2) => this.textInput2 = input2} onKeyDown={this.handleKeyDown2} />
